...
def tag_special_ingredients(dish):
    ...
    special_ingredients = set(dish_ingredients).intersection(SPECIAL_INGREDIENTS)
...
def separate_appetizers(dishes, appetizers):
    ...
    return list(set(dishes) - appetizers_set)
...
def singleton_ingredients(dishes, intersection):
    ...
    category_ingredients = intersection 
    singleton_ingredients = all_ingredients - category_ingredients
